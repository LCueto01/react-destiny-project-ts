...
export const headArmorData:Array<armor> = [{
    "id": 8,
    "light_level": 1410,
    "name": "Toughjoyfax",
...
export const armsArmorData:Array<armor> = [
    {
      "id": 1,
      "light_level": 1531,
      "name": "Sonsing",
...
export const chestArmorData:Array<armor> =[ {
    "id": 7,
    "light_level": 1564,
    "name": "Fixflex",
...
export const legsArmorData:Array<armor> = [{
    "id": 16,
    "light_level": 1454,
    "name": "Bigtax",
...
export const bootsArmorData:Array<armor> = [ {
    "id": 5,
    "light_level": 1518,
    "name": "Tin",
  ...
  export const classItemsData: Array<armor> = [{
    "id": 52,
    "light_level": 1591,
    "name": "Bamity",
 ...
 export const primaryWeaponsData: Array<weapon> = [
    {
      "id": 51,
      "light_level": 1600,
      "name": "systemic",
    ...
    export const secondaryWeaponsData: Array<weapon> = [{
        "id": 54,
        "light_level": 1469,
        "name": "monitoring",
      ...
      export const heavyWeaponsData: Array<weapon> = [{
        "id": 55,
        "light_level": 1487,
        "name": "Function-based",
